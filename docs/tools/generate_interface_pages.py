...
SECTION_ORDER = {
    "Getting Started": 100,
    "Convert and Export": 200,
    "Output and Appearance": 210,
    "Data and Security": 220,
    "Server": 250,
    "Advanced": 300,
    "API Reference": 900,
}
...
def wrapper_text(interface: str, topic: Topic) -> str:
...
def write_index(interface: str, topics: list[Topic], expected: set[Path]) -> None:
    ...
    lines = [
        "<!-- Generated by docs/tools/generate_interface_pages.py. Do not edit. -->",
        "",
        f"# {details['title']}",
        "",
        details["description"],
